...
public class T19 extends JsonPlaceHolder {
    /*
...
*/
    ...
    public void exercise(){
        ...
        JSONObject reqBody= JsonTestData.reqDataCreate();
        JSONObject expBody=JsonTestData.expDataCreate();

        Response response=given().contentType(ContentType.JSON).when().spec(specPlace).body(reqBody.toString()).put("{pp1}/{pp2}");
